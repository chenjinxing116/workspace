...
public class HttpClientUtil {  
     ...
     * @return 远程主机响应正文 
     */  
    public static HttpWrapResponse sendGetRequest(String reqURL){  
        String respContent = "通信失败"; //响应内容  
        HttpWrapResponse baseReponse = new HttpWrapResponse();
        ...
        try{  
            ...
            baseReponse.setHttpCode(response.getStatusLine().getStatusCode());
            baseReponse.setResponse(response);
            if(null != entity){  
                ...
                baseReponse.setHttpResponseContext(respContent);
            }  
            System.out.println("-------------------------------------------------------------------------------------------");  
...
//            LogUtil.getLogger().error("请求通信[" + reqURL + "]时偶遇异常,堆栈轨迹如下", e);  
     ...
     * @return 远程主机响应正文 
     */  
    public static HttpWrapResponse sendPostRequest(String reqURL, UrlEncodedFormEntity formEntity,String cookieData, String encodeCharset){  
        ...
        if(cookieData != null && !cookieData.equalsIgnoreCase("")) httpPost.setHeader("Cookie", cookieData);
        try{
            if(formEntity != null) httpPost.setEntity(formEntity);
...
//            LogUtil.getLogger().error("请求通信[" + reqURL + "]时偶遇异常,堆栈轨迹如下", e);  
    ...
    public static HttpWrapResponse sendPostRequest(String reqURL, Map<String, String> params) throws UnsupportedEncodingException{
        ...
        return HttpClientUtil.sendPostRequest(reqURL,formEntity,null,"UTF-8");
    }
    
    public static HttpWrapResponse sendPostRequestWithCookie(String reqURL, Map<String, String> params,String cookieData) throws UnsupportedEncodingException{
        UrlEncodedFormEntity formEntity = null;
        if(null != params){  
            List<NameValuePair> formParams = new ArrayList<NameValuePair>();  
            for(Map.Entry<String,String> entry : params.entrySet()){  
        ...
        return HttpClientUtil.sendPostRequest(reqURL,formEntity,cookieData,"UTF-8");
    }
