...
//	var obj = document.getElementById("storageId");
//	var oldText = obj.options[0].innerText;

	$("#storageId").empty();
//	if(oldText) {
//		if(oldText != '无') {
//			$("#storageId").append('<option>' + oldText + '</option>');
//		}
//	}
	$("#storageId").append('<option>无</option>');
	$("#storageId").append(html);
	
	var row = parent.getSelectedRow();
	$option = $("[storageid='"+row.superStorage+"']").attr("selected",true);
}
//关闭弹出窗口
